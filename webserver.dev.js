...
ServletContext.prototype.watch = function(){
    ...
    {
        var instance = this;
        this.fileWatchDog = new FileWatchDog(lib);
        this.fileWatchDog.listener = function(f1, f2){
...
var FileWatchDog = function(home){
    this.home = home;
    this.list = [];
    this.timer = null;
    this.listener = null;
...
FileWatchDog.prototype.watch = function(){
    ...
    else
    {
        ...
        FileIterator.each(this.home, function(file){
            ...
            if(stats.isFile())
            {
                ...
                if(list[i].lastModified != stats.mtime.getTime())
                {
                    f1 = file;
                    f2 = list[i].file;
                    return false;
    ...
    var instance = this;
    this.timer = setTimeout(function(){instance.watch()}, 5000);
};
