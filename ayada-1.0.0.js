...
(function(){
    ...
    TemplateCompiler.prototype.startTag = function(stack, list){
        ...
        else if(this.stream.peek() != '!')
        {
            ...
            if(nodeName == "t:include")
            {
                ...
                {
                    throw new Error("The 't:include' direction must be self-closed!");
                }
            ...
            if(nodeName == "t:import")
            {
                ...
                if(this.stream.peek(-2) != '/')
                {
                    throw new Error("The 't:import' direction must be self-closed!");
                }
    ...
    TemplateCompiler.prototype.popNode = function(stack, list, nodeName){
        ...
        if(node == null)
        {
            throw new Error("Exception at line #" + this.lineNumber + ": </" + nodeName + "> not match !");
        }
    ...
    TemplateCompiler.prototype.include = function(stack, list, path, encoding){
        if(path == null)
        {
            throw new Error("t:include error: attribute 'file' not exists !");
        }
...
(function(){
    ...
    var Interface = function(){throw new Error("InterfaceException: This metod not implement !");};
     ...
     * @return int
     */
    Tag.prototype.doStartTag = Interface;

    /**
     * @return int
     */
    Tag.prototype.doEndTag = Interface;

    /**
     * @param parent
     */
    Tag.prototype.setParent = Interface;

    /**
     * @param parent
     */
    Tag.prototype.getParent = Interface;

    /**
     * @param pageContext
     */
    Tag.prototype.setPageContext = Interface;

    /**
     * @return PageContext
     */
    Tag.prototype.getPageContext = Interface;

    /**
     *
     */
    Tag.prototype.release = Interface;
     ...
     * @return int
     */
    IterationTag.prototype.doAfterBody = Interface;
     ...
     * @return boolean
     */
    LoopTagSupport.prototype.hasNext = Interface;

    /**
     * @return boolean
     */
    LoopTagSupport.prototype.next = Interface;
     ...
     * @return int
     */
    LoopTagStatus.prototype.getBegin = Interface;

    /**
     * @return int
     */
    LoopTagStatus.prototype.getCount = Interface;

    /**
     * @return Object
     */
    LoopTagStatus.prototype.getCurrent = Interface;

    /**
     * @return int
     */
    LoopTagStatus.prototype.getEnd = Interface;

    /**
     * @return int
     */
    LoopTagStatus.prototype.getIndex = Interface;

    /**
     * @return int
     */
    LoopTagStatus.prototype.getStep = Interface;

    /**
     * @return boolean
     */
    LoopTagStatus.prototype.isFirst = Interface;

    /**
     * @return boolean
     */
    LoopTagStatus.prototype.isLast = Interface;
     ...
     * @return int
     */
    BodyTag.prototype.doInitBody = Interface;
     ...
     */
    BodyTag.prototype.setBodyContent = Interface;
...
(function(){
    ...
    OtherwiseTag.prototype.doStartTag = function(){
        ...
        if(parent == null)
        {
            throw new Error("otherwise tag must be in choose tag !");
        }
    ...
    WhenTag.prototype.doStartTag = function(){
        ...
        if(parent == null)
        {
            throw new Error("when tag must be in choose tag !");
        }
    ...
    ParameterTag.prototype.doEndTag = function(){
        ...
        {
            throw new Error("Illegal use of parameter-style tag without servlet as its direct parent");
        }
    };
